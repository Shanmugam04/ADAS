...
y_train=to_categorical(y_train,noOfClasses)   # TO CONVERT TO MATRIX FORM
...
def myModel():
    ...
    size_of_Filter2=(3,3)
    size_of_pool=(2,2) # SCALE DOWN ALL FEATURE MAP TO GERNALIZE MORE, TO REDUCE OVERFITTING. IT IS THE WINDOW SIZE
